...
export const siteConfig = {
  ...
  mapQuery: "47.90554867021821,106.92063564417441",
  workingHours: l(
...
export const aboutContent = {
  ...
  /** Хөтөлбөрийн зорилтууд — жишээ (admin-аас нэмж/хасаж, зассаар байх боломжтой). */
  programMilestones: [
    { glyph: "◈", title: l("Дотоод тэнцвэр", "Inner balance", "내면의 균형", "内なる調和", "内在平衡"),
      text: l("Амьсгал, анхаарлыг нэгтгэсэн үндсэн дасгалуудаар эхэлнэ.", "Begins with foundational breath and attention practices.", "호흡과 주의를 통합한 기본 연습으로 시작합니다.", "呼吸と意識を統合した基礎практисで始まります。", "从整合呼吸与专注的基础练习开始。") },
    { glyph: "✷", title: l("Мэдлэг гүнзгийрүүлэх", "Deepening knowledge", "지식 심화", "知識を深める", "深化认知"),
      text: l("Онол, практикийг хослуулсан удирдамжтай алхмууд.", "Guided steps that pair theory with practice.", "이론과 실습을 결합한 단계별 안내.", "理論と実践を組み合わせた段階的な指導。", "理论与实践相结合的引导步骤。") },
    { glyph: "☾", title: l("Дадал бэхжүүлэх", "Building habit", "습관 형성", "習慣を築く", "养成习惯"),
      text: l("Тогтмол дадлагаар өдөр тутмын амьдралд шингээнэ.", "Regular practice woven into daily life.", "꾸준한 연습을 일상에 녹여냅니다.", "日々の生活に定期的な練習を取り入れます。", "通过持续练习融入日常生活。") },
    { glyph: "✶", title: l("Тогтвортой өсөлт", "Lasting growth", "지속적인 성장", "持続的な成長", "持续成长"),
      text: l("Хамт олон, дэмжлэгтэйгээр урт хугацааны үр дүнд хүрнэ.", "Reaching long-term results with community support.", "커뮤니티의 지지와 함께 장기적인 결과에 도달합니다.", "コミュニティの支えとともに長期的な成果へ。", "在社群支持下实现长期成效。") },
  ],
};

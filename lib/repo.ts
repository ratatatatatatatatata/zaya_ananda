...
export async function getSettings(): Promise<SiteSettings> {
  try {
    ...
    return {
      logo: r.logo, aboutTitle: r.aboutTitle, aboutBody: r.aboutBody, aboutVideo: r.aboutVideo, heroVideos: r.heroVideos, heroMedia: r.heroMedia, zurhaiCards: r.zurhaiCards, customMoods: r.customMoods, zurhaiRules: r.zurhaiRules,

        ...
        <div className="container-px">
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="relative isolate flex items-center justify-center overflow-hidden rounded-4xl border border-line bg-gradient-to-br from-aqua to-primary-50 p-10">
              ...
              {p.badge && (<span className="absolute left-6 top-6 z-10 rounded-full bg-surface-2/90 px-3 py-1 text-xs font-bold text-ink"><Tr v={p.badge} /></span>)}
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-8 grid gap-3 text-sm text-muted">
                <div className="flex items-center gap-3 rounded-2xl border border-line bg-surface-1 p-4">🔒 <T k="productDetail.secure" /></div>
                <div className="flex items-center gap-3 rounded-2xl border border-line bg-surface-1 p-4">↩ <T k="productDetail.returns" /></div>
              </div>
            </div>
          </div>
        </div>

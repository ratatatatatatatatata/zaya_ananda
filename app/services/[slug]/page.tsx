          ...
          <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 text-sm font-medium text-ink/70">
                <span className="rounded-full border border-line bg-surface-1 px-4 py-2">⏱ <Tr v={s.duration} /></span>
                {s.deliveryType && <span className="rounded-full border border-line bg-surface-1 px-4 py-2">📍 <Tr v={s.deliveryType} /></span>}
                {s.instructor && <span className="rounded-full border border-line bg-surface-1 px-4 py-2">👤 {s.instructor}</span>}
              </div>
            </div>

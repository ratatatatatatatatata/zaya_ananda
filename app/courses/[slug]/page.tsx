          ...
          <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 text-sm font-medium text-ink/70">
                <span className="rounded-full border border-line bg-surface-1 px-4 py-2">📚 {c.lessons} <T k="common.lessons" /></span>
                <span className="rounded-full border border-line bg-surface-1 px-4 py-2">🗓 <Tr v={c.duration} /></span>
                {c.instructor && <span className="rounded-full border border-line bg-surface-1 px-4 py-2">👤 {c.instructor}</span>}
                {typeof c.students === "number" && <span className="rounded-full border border-line bg-surface-1 px-4 py-2">👥 {c.students.toLocaleString()}</span>}
              </div>
            </div>
            {/* intro preview */}

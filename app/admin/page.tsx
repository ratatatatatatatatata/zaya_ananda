...
export default function AdminPage() {
  ...
  if (!user) {
    return <div className="section"><div className="container-px"><div className="mx-auto max-w-md rounded-4xl border border-line bg-surface-1 p-10 text-center shadow-card">

      ...
      <div className="container-px">
        ...
        {step === "done" && order ? (
          <div className="mx-auto max-w-xl">
            <div className="rounded-4xl border border-line bg-surface-1 p-8 text-center shadow-card sm:p-10">
                ...
                <div className="card p-6 sm:p-8">
                  ...
                  {method === "qpay" ? (
                    <div className="mt-6 flex flex-col items-center rounded-3xl bg-aqua p-6 text-center">
                      ...
                      <svg viewBox="0 0 25 25" className="mt-4 h-44 w-44 rounded-xl bg-surface-1 p-2 shadow-card">

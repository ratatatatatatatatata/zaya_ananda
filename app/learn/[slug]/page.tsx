...
export default function LearnPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      {/* learning top bar */}
      <div className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-line bg-[#16233E]/90 px-4 py-3 backdrop-blur">
      ...
      <div className="grid lg:grid-cols-[1fr_360px]">
          ...
          <div className="relative aspect-video overflow-hidden rounded-2xl bg-[#0c2b29] shadow-lift">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 p-3">
              <div className="mb-2 h-1.5 w-full overflow-hidden rounded-full bg-white/25">
                <div className="h-full rounded-full bg-[#1A2742]" style={{ width: (total ? (elapsed / total) * 100 : 0) + "%" }} />
              </div>
        ...
        {/* sidebar */}
        <aside className="order-1 border-b border-line bg-[#1A2742] p-4 lg:order-2 lg:border-b-0 lg:border-l">

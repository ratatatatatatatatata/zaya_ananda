  ...
  return (
    <div className="mt-8 space-y-3">
      {classes.map((c, i) => {
        ...
        return (
          <div key={c.id} className={cx("overflow-hidden rounded-2xl border bg-surface-1 transition-shadow", isOpen ? "border-primary-300 shadow-glow" : "border-line hover:border-primary-300")}>
            <button
              type="button"

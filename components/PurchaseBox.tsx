    ...
    <div className="card p-6">
      ...
      {step === "qpay" && (
        <div className="space-y-3 text-center">
          ...
          <div className="mx-auto grid h-40 w-40 grid-cols-9 gap-0.5 rounded-2xl border border-line bg-surface-3 p-2">
            {Array.from({ length: 81 }).map((_, i) => <div key={i} className={fnv(id + "qr" + i) % 10 < 5 ? "bg-primary-200" : "bg-surface-3"} />)}
          </div>

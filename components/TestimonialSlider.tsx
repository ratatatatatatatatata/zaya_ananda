  ...
  return (
    <div className="relative">
      ...
      <div className="mt-6 flex justify-center gap-3">
        <button onClick={() => scroll(-1)} className="grid h-12 w-12 place-items-center rounded-full border-2 border-line bg-surface-1 text-xl text-ink/70 transition hover:border-primary-300 hover:text-primary-700" aria-label="Previous">←</button>
        <button onClick={() => scroll(1)} className="grid h-12 w-12 place-items-center rounded-full border-2 border-line bg-surface-1 text-xl text-ink/70 transition hover:border-primary-300 hover:text-primary-700" aria-label="Next">→</button>
      </div>
    </div>
  );
}

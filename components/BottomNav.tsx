...
export function BottomNav() {
  ...
  return (
    <nav className="mobile-dock fixed inset-x-0 bottom-0 z-40 border-t border-line bg-ivory/95 backdrop-blur-xl lg:hidden" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>

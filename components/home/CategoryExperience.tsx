...
export function CategoryExperience({ services, products, journeys }: { services: CmsItem[]; products: CmsItem[]; journeys: Journey[] }) {
  const { t, lang } = useI18n();
  const lists = { services, shop: products.filter(p => p.category !== "Чулуунууд") };

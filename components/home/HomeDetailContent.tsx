...
export default function HomeDetailContent({ item, journey: j }: { item?: CmsItem; journey?: Journey }) {
  ...
  return <div className={styles.detail}>
    ...
    {!!j.destination?.length && <section><h3>Очих газрууд</h3><p>Зураг дээр курсороо аваачих эсвэл дарж дэлгэрэнгүй мэдээллийг томоор үзээрэй.</p><DestinationGallery places={j.destination} scene={j.scene} /></section>}
    ...
    <JourneyRegistration journey={j} headingLevel={3} />

...
## 11. 2026-07 нэмэлтүүд — 2-р багц

**Заавал ажиллуулах SQL:**

```sql
alter table cms_items add column if not exists moods jsonb;
alter table cms_items add column if not exists i18n jsonb;
alter table pages add column if not exists i18n jsonb;
```

**Хийгдсэн:**
- **Ангилал шинэчлэгдсэн** (`data/cms-taxonomy.ts`): Үйлчилгээ — Оношилгоо (Аура, Сканнер), Зурхай ба Мэргэ (Тоон зурхайн матрикс, Шагайн мэргэ), Засал/Эмчилгээ (Advanced, Лаа засал, Жэт аппарат, Озонатор, Хувь заяаны засал); Сургалт — Бясалгалын сургалт, Сүнслэг аялал. Үйлчилгээ хуудсанд бүлэг таб + дэд ангиллын chip шүүлт.
- **Цэс шинэ нэршилтэй** (5 хэлээр, `data/strings.ts`): Энергийн засал, Ариусахуйн үйл, Энергийн хамгаалалт, Гэгээрлийн зам + шинэ: Удирдагч багш нар (`/teachers`), Сэтгэлийн туяа (`/mood`), Гэгээн бэлэг (`/gift`).
- **Багш нар**: `/teachers` (teso-маягийн грид), `/teachers/[нэр]` (masterclass-маягийн танилцуулга + тухайн багшийн хөтөлдөг хичээл/үйлчилгээ автоматаар). Багшийн профайл контент хадгалахад автоматаар үүснэ; форм дээр "Албан тушаал / чиглэл" талбар нэмэгдсэн.
- **Сэтгэлийн туяа** (`/mood`): goodali-маягийн мүүд сонголт (9 мэдрэмж, `MOODS`); админ контентдоо мүүд таг сонгодог (`cms_items.moods`); тохирсон хичээл санал болгоно (`/api/content`).
- **Гэгээн бэлэг** (`/gift`): үнэгүй нээлттэй хичээлүүд — админд "Гэгээн бэлэг" таб (kind=`free`), видеонууд нээлттэй.
- **Контентын 5 хэлний орчуулга** (`cms_items.i18n`, `pages.i18n`): админ формд 🇲🇳🇬🇧🇰🇷🇯🇵🇨🇳 таб — гарчиг/дэлгэрэнгүйг хэл бүрээр гараар оруулна. Хоосон орхивол монгол хувилбар харагдана. Ангиллын нэрс кодонд орчуулгатай (`CAT_I18N`). Харуулах тал: `lib/cms-i18n.ts` + `components/CmsText.tsx` + шинэчилсэн `RichBody`/`CmsCard`/`PromoBanner`/Header.
